          ...
          <thead className="sticky top-0 z-20 bg-card/95 backdrop-blur">
            <tr>
              ...
              {trainers.map((trainer) => (
                ...
                >
                  <Button title={trainer.name} variant="ghost" className="h-auto w-full max-w-full justify-start overflow-hidden px-0.5 py-1 text-left" onClick={() => onTrainer(trainer.id)}>
