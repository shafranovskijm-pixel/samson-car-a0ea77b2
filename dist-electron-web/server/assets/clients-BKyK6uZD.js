import { B as listCars, H as listClients, L as listAppointmentsByClient, M as humanizeSupabaseError, N as listAllClientComments, R as listBrands, S as deleteClientComment, V as listClientComments, a as createBrand, at as updateCar, c as createClient, ct as updateClientComment, l as createClientComment, o as createCar, st as updateClient, x as deleteClient, y as deleteCar, z as listCarModels } from "./api-DUIXY4t-.js";
							...
							children: /* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, {
								...
								children: /* @__PURE__ */ jsxs("button", {
									...
									children: [/* @__PURE__ */ jsxs("span", {
										...
										children: [/* @__PURE__ */ jsx(Filter, { className: "h-3.5 w-3.5 text-muted-foreground" }), categoryFilter === "all" ? "Все категории" : /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsx("span", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx(Button, {
										...
										children: selected.is_archived ? /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsx(ArchiveRestore, { className: "mr-1 h-4 w-4" }), "Восстановить"] }) : /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsx(Archive, { className: "mr-1 h-4 w-4" }), "В архив"] })
									}),
									/* @__PURE__ */ jsx(Button, {
										variant: "outline",
										size: "sm",
	...
	const saveM = useMutation({
		mutationFn: async () => {
			...
			const payload = {
				...
				engine_volume: form.engine_volume ? Number(form.engine_volume) > 20 ? +(Number(form.engine_volume) / 1e3).toFixed(1) : +Number(form.engine_volume).toFixed(1) : null,
		...
		children: [
			...
			items.length === 0 && !adding ? /* @__PURE__ */ jsx("div", {
				...
				children: items.map((c) => {
					return /* @__PURE__ */ jsx("div", {
						className: "rounded-lg border bg-card p-3 text-sm",
						children: editingId === c.id ? /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsx(Textarea, {
							value: editDraft,
