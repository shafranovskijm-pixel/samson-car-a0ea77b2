...
function ExpensesMonthlyTable({ month, appts, mechanics, advances, mechById, svcById }) {
	...
	const filtered = useMemo(() => mechFilter === "all" ? rows : rows.filter((r) => r.mechanicId === mechFilter), [rows, mechFilter]);
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("h3", {
					...
					children: "Работы, начисления мастерам и авансы — одной таблицей"
				})]
			}), /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("select", {
						...
						}), mechanics.map((m) => /* @__PURE__ */ jsx("option", {
							value: m.id,
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: ["Сводная за ", monthLabel]
				}), mechFilter !== "all" && /* @__PURE__ */ jsxs("div", {
					className: "text-sm",
					children: ["Мастер: ", mechanics.find((m) => m.id === mechFilter)?.full_name ?? "—"]
				})]
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					children: [
						/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", {
							className: "border-b bg-muted/40 text-left text-xs uppercase tracking-wider text-muted-foreground",
							children: [
								/* @__PURE__ */ jsx("th", {
									className: "px-2 py-2",
									children: "Число"
						...
						/* @__PURE__ */ jsx("tbody", { children: filtered.map((r, i) => /* @__PURE__ */ jsxs("tr", {
						...
						/* @__PURE__ */ jsx("tfoot", { children: /* @__PURE__ */ jsxs("tr", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("td", { className: "px-2 py-2" }),
								/* @__PURE__ */ jsx("td", {
									className: "whitespace-nowrap px-2 py-2 text-right tabular-nums",
									children: fmt$1(totals.price)
								}),
								/* @__PURE__ */ jsx("td", {
									className: "whitespace-nowrap px-2 py-2 text-right tabular-nums text-amber-700",
									children: fmt$1(totals.payout)
								}),
								/* @__PURE__ */ jsx("td", {
									className: "whitespace-nowrap px-2 py-2 text-right tabular-nums text-red-600",
									children: fmt$1(totals.advance)
								})
							]
						}) })
					]
