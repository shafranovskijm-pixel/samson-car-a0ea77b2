...
import { i as useLoginHero } from "./useLoginHero-DylFcfAS.js";
...
function LoginPage() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-black/50 backdrop-blur-[2px]" }), /* @__PURE__ */ jsxs(Card, {
			className: "relative z-10 w-full max-w-sm border-white/10 bg-background/90 shadow-2xl backdrop-blur-md",
