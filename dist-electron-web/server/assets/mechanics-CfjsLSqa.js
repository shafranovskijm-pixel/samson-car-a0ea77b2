import { $ as listServices, E as deleteMechanicShift, G as listMechanicPayouts, J as listMechanics, K as listMechanicServiceRates, T as deleteMechanicAdvance, W as listMechanicAdvances, ct as updateMechanic, d as createMechanic, f as createMechanicAdvance, lt as updateMechanicDefaultPayoutPercent, mt as upsertMechanicServiceRate, p as createMechanicShift, q as listMechanicShifts, w as deleteMechanic } from "./api-CVw9HSQ1.js";
...
function MechanicShifts({ mechanicId, color = "#64748b" }) {
	...
	const saveM = useMutation({
		mutationFn: async () => {
			...
			if (editing) {
				const { updateMechanicShift } = await import("./api-CVw9HSQ1.js").then((n) => n.t);
