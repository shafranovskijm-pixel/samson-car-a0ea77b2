import { $ as listServices, A as getAppointment, B as listCars, F as listAppointmentPayments, H as listClients, J as listMechanics, K as listMechanicServiceRates, M as humanizeSupabaseError, R as listBrands, _ as deleteAppointmentPayment, dt as updateService, et as updateAppointment, g as deleteAppointment, ht as upsertServiceByCategoryName, i as createAppointmentPayment, j as getPriceForBrand, r as createAppointment, z as listCarModels } from "./api-CVw9HSQ1.js";
...
function AppointmentDialog({ open, onOpenChange, appointmentId, defaultStart, defaultCarId, defaultServices, defaultBrandId, defaultModelId }) {
	...
	const saveMutation = useMutation({
		mutationFn: async () => {
			...
			const servicesPayload = selected.map((s) => manualPayouts.has(s.service_id) ? s : {
				...s,
				mechanic_payout: rateFor(s.service_id, s.price)
			});
			const payload = {
...
//#endregion
export { ussDayKey as a, isYesterdayUss as i, isTodayUss as n, isTomorrowUss as r, AppointmentDialog as t };
