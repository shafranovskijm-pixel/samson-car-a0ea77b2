import { C as deleteMechanic, G as listMechanicShifts, H as listMechanicAdvances, K as listMechanics, T as deleteMechanicShift, U as listMechanicPayouts, W as listMechanicServiceRates, X as listServices, at as updateMechanicDefaultPayoutPercent, ct as upsertMechanicServiceRate, d as createMechanic, f as createMechanicAdvance, it as updateMechanic, p as createMechanicShift, w as deleteMechanicAdvance } from "./api-5HwrZJyw.js";
...
function MechanicShifts({ mechanicId, color = "#64748b" }) {
	...
	const saveM = useMutation({
		mutationFn: async () => {
			...
			if (editing) {
				const { updateMechanicShift } = await import("./api-5HwrZJyw.js").then((n) => n.t);
