import { $ as listServices, A as getAppointment, B as listCars, F as listAppointmentPayments, H as listClients, J as listMechanics, K as listMechanicServiceRates, M as humanizeSupabaseError, R as listBrands, _ as deleteAppointmentPayment, ft as updateService, g as deleteAppointment, gt as upsertServiceByCategoryName, i as createAppointmentPayment, j as getPriceForBrand, r as createAppointment, tt as updateAppointment, z as listCarModels } from "./api-DUIXY4t-.js";
...
import { n as useServiceUsage, t as useCarCustomServices } from "./useCarCustomServices-KaxC_QJl.js";
import { i as ussDateISO, o as ussLocalToInstant, s as ussTimeHM } from "./tz-BRzMydUb.js";
...
function AppointmentDialog({ open, onOpenChange, appointmentId, defaultStart, defaultCarId, defaultServices, defaultBrandId, defaultModelId }) {
	...
	const [manualPayouts, setManualPayouts] = useState(/* @__PURE__ */ new Set());
	...
	useEffect(() => {
		...
		setAddServiceId("");
		setManualPayouts(/* @__PURE__ */ new Set());
		setReminderOn(false);
	...
	const saveMutation = useMutation({
		mutationFn: async () => {
			...
			const prevRows = new Map((existing?.services ?? []).map((s) => [s.service_id, {
			...
			const servicesPayload = selected.map((s) => {
				...
				if (prev && !mechChangedOnSave && prev.price === Number(s.price ?? 0) && prev.payout > 0) return {
					...s,
					mechanic_payout: prev.payout
				};
				return {
					...s,
					mechanic_payout: rateFor(s.service_id, s.price)
		...
		onSuccess: () => {
			...
			bump(selected.map((s) => s.service_id).filter((id) => id && !id.startsWith("custom:")));
								...
								children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [isEdit && /* @__PURE__ */ jsx(Button, {
											...
											children: "Пересчитать по текущим ставкам"
										}), /* @__PURE__ */ jsxs(Badge, {
											variant: "secondary",
											className: "text-base",
											children: [
