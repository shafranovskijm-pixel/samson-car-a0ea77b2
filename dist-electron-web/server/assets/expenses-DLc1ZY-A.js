import { $ as listServices, C as deleteExpense, I as listAppointments, J as listMechanics, T as deleteMechanicAdvance, U as listExpenses, W as listMechanicAdvances, Y as listPaymentsRange, f as createMechanicAdvance, u as createExpense } from "./api-CVw9HSQ1.js";
						...
						/* @__PURE__ */ jsxs("tfoot", { children: [/* @__PURE__ */ jsxs("tr", {
							...
							children: [/* @__PURE__ */ jsx("td", {
								...
								return /* @__PURE__ */ jsxs(Fragment, { children: [
									...
									/* @__PURE__ */ jsx("td", {
										className: "whitespace-nowrap px-2 py-2 text-right tabular-nums",
										children: fmt$1(t.price)
									}, `${m.id}-ts`),
									/* @__PURE__ */ jsx("td", {
										className: "whitespace-nowrap px-2 py-2 text-right tabular-nums text-amber-700",
										children: fmt$1(t.payout)
									}, `${m.id}-tz`),
									/* @__PURE__ */ jsx("td", {
										className: "whitespace-nowrap px-2 py-2 text-right tabular-nums text-red-600",
										children: fmt$1(t.advance)
									}, `${m.id}-ta`)
								] }, m.id);
							})]
						}), /* @__PURE__ */ jsx("tr", {
							...
							children: /* @__PURE__ */ jsxs("td", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("span", {
										className: "font-bold",
										children: fmt$1(grandTotals.price)
									}),
									" · ЗП",
									" ",
									/* @__PURE__ */ jsx("span", {
										className: "font-bold text-amber-700",
										children: fmt$1(grandTotals.payout)
									}),
									" · Аванс",
									" ",
									/* @__PURE__ */ jsx("span", {
										className: "font-bold text-red-600",
										children: fmt$1(grandTotals.advance)
									})
								]
							})
						})] })
