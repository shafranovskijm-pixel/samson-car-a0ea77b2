import { I as listAppointments, J as listMechanics, g as deleteAppointment, i as createAppointmentPayment, n as clearAppointmentPayments, nt as updateAppointmentStatus } from "./api-DUIXY4t-.js";
...
import { a as ussDayKey, n as isTomorrowUss, r as isYesterdayUss, t as isTodayUss } from "./tz-BRzMydUb.js";
import { t as AppointmentDialog } from "./AppointmentDialog-CR8V4to0.js";
										...
										children: [/* @__PURE__ */ jsx("span", {
											...
											return /* @__PURE__ */ jsxs("span", {
												...
												children: [/* @__PURE__ */ jsx("span", {
													...
													className: `rounded-full px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide ${isTodayUss(d) ? "bg-primary/10 text-primary" : "bg-muted text-muted-foreground"}`,
													children: rel
												})]
											});
										})()]
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										payDlg.paid > 0 && /* @__PURE__ */ jsxs(Fragment$1, { children: [" · уже внесено ", /* @__PURE__ */ jsxs("span", {
											className: "font-medium text-foreground",
